...
function UploadImg() {
    const [fileNames, setFileNames] = useState([]); // Lista de nombres de archivos
  ...
  const handleFileInput = (e) => {
    const files = Array.from(e.target.files).filter(
      (file) => file.type.startsWith("image/") // Acepta solo imágenes
    );
